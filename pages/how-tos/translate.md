...
We use [Crowdin](https://crowdin.komodo-os.my.id) as our translation system. To submit translations you need to create an [account](https://crowdin.com/join), click the desired language and start suggesting translations.
...
After the validation of the strings, they will be merged into the next official monthly release of Komodo OS.
...
{% include alerts/note.html content="If you feel like the proofreader (who is a volunteer as well) is not doing a good job or isn't active anymore, feel free to send him a message or notify one of the [Managers](https://komodo-os.my.id/team.html) about it." %}
...
2. Strings with `xliff` tags, e.g. `<xliff:g id="name" example="Help improve Komodo OS">%1$s</xliff:g>`: Keep the whole thing untouched and embed it into your translation at an appropriate place.
...
Contact one of the managers [here](https://crowdin.komodo-os.my.id) if you want to be a proofreader.
